...
import tagProcessor from '../support/tagProcessor';
...
const videoReporterConfig = argv.video ? [[videoReporter, {
  saveAllVideos: false,
...
const config = {
  ...
  //@ts-ignore
  reporters: ['spec'].concat(videoReporterConfig),
  ...
  cucumberOpts: {
    ...
    require: [
      './wdio/support/world.ts',
      './wdio/features/step-definitions/**/*.steps.ts',
    ],
